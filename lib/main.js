...
class Fido2Lib {
    ...
    */
     ...
     */
    async attestationResult(res, expected, options) {
        options = options || {
            android: {
                rpId: ''
            }
        ...
        return Fido2AttestationResult.create(res, expected, options);
    }
     ...
     * @throws {Error} If parsing or validation fails
     */
    async assertionResult(res, expected, options) {
        options = options || {
            android: {
                rpId: ''
            }
        ...
        delete expected.factor;
        return Fido2AssertionResult.create(res, expected, options);
    }
