...
class Fido2AttestationResult extends Fido2Result {
    ...
    static create(req, exp, ops) {
        return new Fido2AttestationResult(lockSym).create(req, exp, ops);
    }
}
...
class Fido2AssertionResult extends Fido2Result {
    ...
    static create(req, exp, ops) {
        return new Fido2AssertionResult(lockSym).create(req, exp, ops);
    }
}
